...
const FLOWS = [
    ...
    },
    {
        ...
        responses: [
            ...
            'Para saber o prazo real do SEU caso, preciso entender onde você está hoje. Me conta: o maior problema é atrair clientes, atendimento ou fechamento?',
        ],
    },
    {
        id: 'agendamento',
    ...
    },
    {
        ...
        responses: [
            'Entendi! Esse é exatamente o tipo de problema que resolvemos — venda que inicia mas não fecha costuma ser sinal de gargalo no atendimento ou no processo de filtragem. 🎯',
